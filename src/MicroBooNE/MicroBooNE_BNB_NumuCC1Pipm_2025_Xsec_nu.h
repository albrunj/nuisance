...
*******************************************************************************/
#ifndef MICROBOONE_CC1PIPM_2025_NU_H_SEEN
#define MICROBOONE_CC1PIPM_2025_NU_H_SEEN
...
class MicroBooNE_BNB_NumuCC1Pipm_2025_XSec_nu : public Measurement1D {
...
public:
  ...
  /// Virtual Destructor
  inline virtual ~MicroBooNE_BNB_NumuCC1Pipm_2025_XSec_nu() {
    fResidualHist = NULL;
